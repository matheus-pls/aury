                  ...
                  >
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3">
                        <p className="text-xs text-emerald-700 mb-1">💡 Próximo passo</p>
                        <p className="text-sm font-medium text-emerald-900">
                          {monthlySaving > 0 ? (
                            <>Economize {formatCurrency(monthlySaving)} por mês e alcance em {Math.ceil((goal.target_amount - (goal.current_amount || 0)) / monthlySaving)} meses</>
                          ) : (
                            <>Defina um prazo para calcular quanto economizar por mês</>
                          )}
                        </p>
                      </div>
                    </div>
