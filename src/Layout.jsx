...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    ...
    <div className="min-h-screen bg-background">
      ...
      {/* Mobile Header */}
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-aury-sidebar/95 backdrop-blur-sm border-b border-border z-40 flex items-center justify-between px-4">
        <button
      ...
      {/* Sidebar */}
      <aside className={`
        fixed top-0 left-0 h-full bg-aury-sidebar border-r border-border z-50
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-border">
            <div className="bg-primary/10 rounded-2xl p-4">
              <p className="text-xs text-muted-foreground mb-1">Controle. Clareza. Confiança.</p>
              <p className="text-sm font-semibold text-foreground">Seu aliado financeiro</p>
            </div>
          </div>
        </div>
      </aside>
