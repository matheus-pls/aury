...
export default function AuryFlowInline({ onSuccess }) {
  ...
  if (inputMode === "idle") {
    return (
      <Button
        ...
        className="w-full h-16 bg-gradient-to-r from-[#5FBDBD] to-[#4FA9A5] hover:from-[#4FA9A5] hover:to-[#5FBDBD] shadow-lg text-white text-lg font-semibold"
      >
      ...
      <AnimatePresence mode="wait">
        ...
        {inputMode === "processing" && (
          ...
          >
            ...
            <p className="text-white/50 text-sm mt-1">A Aury está entendendo</p>
          </motion.div>
        )}
